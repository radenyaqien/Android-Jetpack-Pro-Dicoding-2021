...
object Dummy {
    ...
    fun generatesDummyMovies(): ArrayList<Movies> {
    ...
    fun generatesDummyTvShows(): ArrayList<TvShows> {

        val movie = ArrayList<TvShows>()
    ...
    fun getDummyPopular(): ArrayList<PopularMovies> {
